...
public class KeyPairGeneratorSpi extends java.security.KeyPairGeneratorSpi {
   ...
   public KeyPair generateKeyPair() {
      if (this.algorithmInitialized == 0) {
         ...
         switch (this.algorithmInitialized) {
            ...
            case 3:
            case 4:
               return new KeyPair(new BC11XDHPublicKey(var1.getPublic()), new BC11XDHPrivateKey(var1.getPrivate()));
            default:
               throw new IllegalStateException("generator not correctly initialized");
         }
      }
   ...
   private static String getNameFromParams(AlgorithmParameterSpec var0) throws InvalidAlgorithmParameterException {
      ...
      } else if (var0 instanceof NamedParameterSpec) {
         return ((NamedParameterSpec)var0).getName();
