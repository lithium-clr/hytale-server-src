...
public class HQCDecapsulatorSpi implements DecapsulatorSpi {
   BCHQCPrivateKey privateKey;
   KTSParameterSpec parameterSpec;
   HQCKEMExtractor kemExt;

   public HQCDecapsulatorSpi(BCHQCPrivateKey var1, KTSParameterSpec var2) {
      this.privateKey = var1;
      this.parameterSpec = var2;
      this.kemExt = new HQCKEMExtractor(var1.getKeyParams());
   }
