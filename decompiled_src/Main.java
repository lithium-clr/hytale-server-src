...
public final class Main {
   public static void main(String[] args) {
      ...
      if (EarlyPluginLoader.hasTransformers()) {
         ...
         com.hypixel.hytale.LateMain.lateMain(args);
      }
   }
   ...
   private static void launchWithTransformingClassLoader(@Nonnull String[] args) {
      try {
         ...
         ClassLoader appClassLoader = com.hypixel.hytale.Main.class.getClassLoader();
   ...
   private static URL[] getClasspathUrls() {
      if (com.hypixel.hytale.Main.class.getClassLoader() instanceof URLClassLoader urlClassLoader) {
