...
public class NTRUPrime {
   ...
   public static class Mappings extends AsymmetricAlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("Kem.SNTRUPRIME", "org.bouncycastle.pqc.jcajce.provider.ntruprime.SNTRUPrimeKEMSpi");
         var1.addAlgorithm("Alg.Alias.Kem." + BCObjectIdentifiers.pqc_kem_sntruprime, "SNTRUPRIME");
      }
   }
}
