...
public class HQC {
   ...
   public static class Mappings extends AsymmetricAlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("KEM.HQC", "org.bouncycastle.pqc.jcajce.provider.hqc.HQCKEMSpi");
         var1.addAlgorithm("Alg.Alias.KEM." + BCObjectIdentifiers.hqc128, "HQC");
         var1.addAlgorithm("Alg.Alias.KEM." + BCObjectIdentifiers.hqc192, "HQC");
         var1.addAlgorithm("Alg.Alias.KEM." + BCObjectIdentifiers.hqc256, "HQC");
      }
   }
}
