...
public class HQCEncapsulatorSpi implements EncapsulatorSpi {
   private final BCHQCPublicKey publicKey;
   private final KTSParameterSpec parameterSpec;
   private final HQCKEMGenerator kemGen;

   public HQCEncapsulatorSpi(BCHQCPublicKey var1, KTSParameterSpec var2, SecureRandom var3) {
      this.publicKey = var1;
      this.parameterSpec = var2;
      this.kemGen = new HQCKEMGenerator(var3);
   }
