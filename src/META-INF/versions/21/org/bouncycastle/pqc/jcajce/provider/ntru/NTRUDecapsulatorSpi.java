...
public class NTRUDecapsulatorSpi implements DecapsulatorSpi {
   BCNTRUPrivateKey privateKey;
   KTSParameterSpec parameterSpec;
   NTRUKEMExtractor kemExt;

   public NTRUDecapsulatorSpi(BCNTRUPrivateKey var1, KTSParameterSpec var2) {
      this.privateKey = var1;
      this.parameterSpec = var2;
      this.kemExt = new NTRUKEMExtractor(var1.getKeyParams());
   }
